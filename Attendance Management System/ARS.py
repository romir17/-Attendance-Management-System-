...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'GHRCE@raisoni.net' ")
...
head2 = tk.Label(frame2, text="                            Register Student                                                ", fg="black",bg="#FFD700" ,font=('Kollektif', 17, ' bold ') )
head2.grid(row=0,column=0)

head1 = tk.Label(frame1, text="                            Mark Attendence                                          ", fg="black",bg="#FFD700" ,font=('Kollektif', 17, ' bold ') )
head1.place(x=0,y=0)
...
clearButton = tk.Button(frame2, text="Clear", command=clear  ,fg="black"  ,bg="#BCBCD1"  ,width=11 ,activebackground = "white" ,font=('times', 11, ' bold '))
clearButton.place(x=335, y=86)
clearButton2 = tk.Button(frame2, text="Clear", command=clear2  ,fg="black"  ,bg="#BCBCD1"  ,width=11 , activebackground = "white" ,font=('times', 11, ' bold '))
clearButton2.place(x=335, y=172)    
takeImg = tk.Button(frame2, text="Take Images", command=TakeImages  ,fg="black"  ,bg="#FFD700"  ,width=34  ,height=1, activebackground = "white" ,font=('Kollektif', 15))
takeImg.place(x=50, y=300)
trainImg = tk.Button(frame2, text="Save Profile", command=psw ,fg="black"  ,bg="#FFD700"  ,width=34  ,height=1, activebackground = "white" ,font=('Kollektif', 15))
trainImg.place(x=50, y=380)
trackImg = tk.Button(frame1, text="Take Attendance", command=TrackImages  ,fg="black"  ,bg="#BCBCD1"  ,width=35  ,height=1, activebackground = "white" ,font=('Kollektif', 15, ' bold '))
trackImg.place(x=35,y=55)
quitWindow = tk.Button(frame1, text="Quit", command=window.destroy  ,fg="#FFFFFF"  ,bg="#CD1C1C"  ,width=35 ,height=1, activebackground = "white" ,font=('Kollektif', 15, ' bold '))
